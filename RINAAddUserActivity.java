...
public class RINAAddUserActivity extends ParentActivity implements View.OnClickListener {
    TextView headername;
    ImageView ic_back;
    Button btnAddUser;
    String Allinfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressdialog = new ProgressDialogView(
                AddPaymentMethodeActivity.this, "");
    ...
    public void ParseInfo(String Allinfo) throws JSONException {
        ...
        customerId = Session.getUserID(AddUserActivity.this);
    }
            ...
            case R.id.btnAddUser:
                try {
                    ...
                    jsonObject1.put("birthDate",
                            month.getSelectedItem()+"/"+spinYear.getSelectedItem());
    ...
    public void CallAPI(JSONObject params) {
        if (Util.isNetworkConnected(AddPaymentMethodeActivity.this)) {
            try {
                ...
                progressdialog.show();
                new CallAPI(ADDPAYMENTUSER, "ADDPAYMENTUSER", params,
                        AddPaymentMethodeActivity.this, GetDetails_Handler, true);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        } else {
            progressdialog.dismissanimation(ProgressDialogView.ERROR);
            Util.ShowToast(AddPaymentMethodeActivity.this,
            ...
            if (msg.getData().getBoolean("flag")) {
                if (msg.getData().getInt("code") == SUCCESS) {
                    ...
                    try {
                        ...
                        Session.setUserID(AddPaymentMethodeActivity.this,
                                jsonObject.getString("customerId"));

                        Session.setEmailId(AddPaymentMethodeActivity.this,
                                jsonObject.getString("email"));

                        Session.setLoginStatus(AddPaymentMethodeActivity.this, true);

                        Session.setAllInfo(AddPaymentMethodeActivity.this,
                                msg.getData().getString("response"));
                        Intent intent = new
                                Intent(AddPaymentMethodeActivity.this, RINATabInvestorActivity.class);
                    ...
                    ParseSessionDetails(msg.getData().getString("respone"));
                    try {
                    ...
                    if
                    (Util.isNetworkConnected(AddPaymentMethodeActivity.this)) {
