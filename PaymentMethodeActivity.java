...
public class PaymentMethodeActivity extends ParentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressdialog = new
                ProgressDialogView(PaymentMethodeActivity.this, "");
    ...
    @Override
    public void onClick(View view Bundle savedInstanceState) {
        ...
        try {
            ...
            e.printStackTrace();
            Util.ShowToast(PaymentMethodeActivity.this, "Error please
            try again!!!");
            finish();
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ic_back:
                if (!isforaddpayment) {
                    Intent intent = new
                            Intent(PaymentMethodeActivity.this, LandingPageActivity.class);
            ...
            case R.id.creditdebit:
                intent = new Intent(PaymentMethodeActivity.this,
                        AddPaymentMethodeActivity.class);
            ...
            case R.id.paypal:
                if (Util.isNetworkConnected(PaymentMethodeActivity.this)) {
                    ...
                    Util.ShowToast(PaymentMethodeActivity.this,
...
for mapping between the
         * attributes you select for this app in the PayPal developer
portal and the scopes required here.
         */
                ...
                if (auth != null) {
                    ...
                    try {
                        ...
                        Log.i("ProfileSharingExample",
                                auth.toJSONObject().toString(4) + "    " + auth.describeContents());
                        Log.i("ProfileSharingExample",
                        ...
                        if (isforaddpayment) {
                            jsonObject.put("customerId",
                                    Session.getUserID(PaymentMethodeActivity.this));
...
//                        gateway User Id – email for paypal
                ...
                Log.i("ProfileSharingExample", "The user canceled.");
                    ...
                    PayPalProfileSharingActivity.RESULT_EXTRAS_INVALID) {
                Log.i("ProfileSharingExample",
        ...
        if (Util.isNetworkConnected(PaymentMethodeActivity.this)) {
            try {
                ...
                if(accountType.equals("C")){
                    new CallAPI(ADDPAYMENTUSER, "ADDPAYMENT", params,
                            PaymentMethodeActivity.this, GetDetails_Handler, true);
                }else if (isforaddpayment) {
                    new CallAPI(ADDPAYMENT, "ADDPAYMENT", params,
                            PaymentMethodeActivity.this, GetDetails_Handler, true);
                } else
                    new CallAPI(ADDPAYMENTUSER, "ADDPAYMENTUSER",
                            params, PaymentMethodeActivity.this, GetDetails_Handler, true);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        } else {
    ...
    public void ProceedButtopn() {
        if (isforaddpayment) {
            ...
            Intent intent = new Intent(PaymentMethodeActivity.this,
                ...
                if (msg.getData().getInt("code") == SUCCESS) {
                    try {
                        if (isforaddpayment) {
                            ...
                            Session.setUserID(PaymentMethodeActivity.this,
                                    jsonObject.getString("customerId"));

                            Session.setEmailId(PaymentMethodeActivity.this,
                                    jsonObject.getString("email"));

                            Session.setLoginStatus(PaymentMethodeActivity.this, true);

                            Session.setAllInfo(PaymentMethodeActivity.this,
