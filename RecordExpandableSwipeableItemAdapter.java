...
public class RecordExpandableSwipeableItemAdapter
        extends
        AbstractExpandableItemAdapter<RecordExpandableSwipeableItemAdapter.MyGroupViewHolder,
                        RecordExpandableSwipeableItemAdapter.MyChildViewHolder> implements
        ExpandableSwipeableItemAdapter<RecordExpandableSwipeableItemAdapter.MyGroupViewHolder,
    ...
    @Override
    public SwipeResultAction onSwipeGroupItem(MyGroupViewHolder myGroupViewHolder, int i, int i1) {
        return null;
    }

    @Override
    public SwipeResultAction onSwipeChildItem(MyChildViewHolder myChildViewHolder, int i, int i1, int i2) {
        return null;
    }
    ...
    public static class MyGroupViewHolder extends MyBaseViewHolder {
        ...
        public MyGroupViewHolder(View v) {
            super(v);
            mIndicator = (ExpandableItemIndicator)
    ...
    public RecordExpandableSwipeableItemAdapter(
        ...
        // ExpandableItemAdapter, ExpandableDraggableItemAdapter and
        ExpandableSwipeableItemAdapter
        // require stable ID, and also have to implement the
        getGroupItemId()/getChildItemId() methods appropriately.
    ...
    @Override
    public MyGroupViewHolder onCreateGroupViewHolder(ViewGroup parent,
                                                     int viewType) {
        final LayoutInflater inflater =
                LayoutInflater.from(parent.getContext());
        final View v =
                inflater.inflate(R.layout.list_group_item_draggable, parent, false);
        return new MyGroupViewHolder(v);
    }

    @Override
    public MyChildViewHolder onCreateChildViewHolder(ViewGroup parent,
                                                     int viewType) {
        final LayoutInflater inflater =
                LayoutInflater.from(parent.getContext());
        final View v = inflater.inflate(R.layout.list_item_draggable,
                parent, false);
        return new MyChildViewHolder(v);
    }

    @Override
    public void onBindGroupViewHolder(MyGroupViewHolder holder, int
            groupPosition, int viewType) {
        // group item
        ...
        if (((expandState & Expandable.STATE_FLAG_IS_UPDATED) != 0) ||
            ...
            boolean animateIndicator
                    = ((expandState &
                    Expandable.STATE_FLAG_HAS_EXPANDED_STATE_CHANGED) != 0);
...
//        }
    ...
    public int onGetChildItemSwipeReactionType(
            MyChildViewHolder holder, int groupPosition, int
            childPosition, int x, int y) {
//        if (onCheckChildCanStartDrag(holder, groupPosition,
        childPosition, x, y)) {
//            return Swipeable.REACTION_CAN_NOT_SWIPE_BOTH_H;
//        }
...
//                } else {
//                    // not pinned --- remove
//                    return new GroupSwipeRightResultAction(this,
                    groupPosition);
//                }
                    // swipe left -- pin
        ...
        public SwipeResultAction onSwipeChildItem(
                MyChildViewHolder holder, int groupPosition, int
        childPosition, int result) {
            switch (result) {
                // swipe right
                case Swipeable.RESULT_SWIPED_RIGHT:
//                if (mProvider.getChildItem(groupPosition,
                    childPosition).isPinned()) {
//                    // pinned --- back to default position
//                    return new ChildUnpinResultAction(this,
                    groupPosition, childPosition);
//                } else {
//                    // not pinned --- remove
//                    return new ChildSwipeRightResultAction(this,
                    groupPosition, childPosition);
//                }
                    // swipe left -- pin
                    case Swipeable.RESULT_SWIPED_LEFT:
                        return new ChildSwipeLeftResultAction(this,
                                groupPosition, childPosition);
                    // other --- do nothing
                    case Swipeable.RESULT_CANCELED:
                    default:
            ...
            private static class GroupSwipeLeftResultAction extends
                ...
                GroupSwipeLeftResultAction(
                        RecordExpandableSwipeableItemAdapter adapter, int
                        groupPosition) {
                    mAdapter = adapter;
...
//            }
            ...
            private static class GroupSwipeRightResultAction extends
...
//            mAdapter.mProvider.removeGroupItem(mGroupPosition);
            ...
            private static class GroupUnpinResultAction extends
                    SwipeResultActionDefault {
                private RecordExpandableSwipeableItemAdapter mAdapter;
                private final int mGroupPosition;

                GroupUnpinResultAction(RecordExpandableSwipeableItemAdapter
                                               adapter, int groupPosition) {
                    mAdapter = adapter;
                    mGroupPosition = groupPosition;
                }
...
//            }
            ...
            private static class ChildSwipeLeftResultAction extends
                    SwipeResultActionMoveToSwipedDirection {
                private RecordExpandableSwipeableItemAdapter mAdapter;
                private final int mGroupPosition;
...
//                    mAdapter.mProvider.getChildItem(mGroupPosition,
                    mChildPosition);
//
//            if (!item.isPinned()) {
//                item.setPinned(true);
//
                    mAdapter.mExpandableItemManager.notifyChildItemChanged(mGroupPosition,
                            mChildPosition);
//                mSetPinned = true;
//            }
                }
                ...
                protected void onSlideAnimationEnd() {
                    ...
                    if (mSetPinned && mAdapter.mEventListener != null) {
                        ...
                        mAdapter.mEventListener.onChildItemPinned(mGroupPosition,
                                mChildPosition);
                    }
                }
            ...
            private static class ChildSwipeRightResultAction extends
                    SwipeResultActionRemoveItem {
                private RecordExpandableSwipeableItemAdapter mAdapter;
                private final int mGroupPosition;
                private final int mChildPosition;

                ChildSwipeRightResultAction(RecordExpandableSwipeableItemAdapter
                                                    adapter,
                                            int groupPosition, int childPosition) {
                    mAdapter = adapter;
                    mGroupPosition = groupPosition;
...
//            mAdapter.mProvider.removeChildItem(mGroupPosition,
                    mChildPosition);
                    mAdapter.mExpandableItemManager.notifyChildItemRemoved(mGroupPosition,
                            mChildPosition);
                }
                ...
                protected void onSlideAnimationEnd() {
                    ...
                    if (mAdapter.mEventListener != null) {
                        ...
                        mAdapter.mEventListener.onChildItemRemoved(mGroupPosition,
                                mChildPosition);
                    }
                }
            ...
            private static class ChildUnpinResultAction extends
                    SwipeResultActionDefault {
                private RecordExpandableSwipeableItemAdapter mAdapter;
                private final int mGroupPosition;
                private final int mChildPosition;
...
//            }
    ...
    @Override
    public void onSetGroupItemSwipeBackground(MyGroupViewHolder myGroupViewHolder, int i, int i1) {

    }

    @Override
    public void onSetChildItemSwipeBackground(MyChildViewHolder myChildViewHolder, int i, int i1, int i2) {
