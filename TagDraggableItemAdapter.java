...
public class TagDraggableItemAdapter
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0)) {
            ...
            if ((dragState & Draggable.STATE_FLAG_IS_ACTIVE) != 0) {
                ...
                // need to clear drawable state here to get correct
                appearance of the dragging item.
    ...
    @Override
    public boolean onCheckCanStartDrag(MyViewHolder holder, int
            position, int x, int y) {
        return true;
    }

    @Override
    public ItemDraggableRange onGetItemDraggableRange(MyViewHolder
                                                              holder, int position) {
