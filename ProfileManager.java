...
import group.lsg.resultinvestmentapp.Profile;
...
public class ProfileManager extends FirebaseListenersManager{
    ...
    public Profile buildProfile(FirebaseUser firebaseUser, String
            largeAvatarURL) {
    ...
    OnObjectExistListener<Profile> onObjectExistListener) {
        DatabaseReference databaseReference =
                databaseHelper.getDatabaseReference().child("profiles").child(id);
    ...
    public void createOrUpdateProfile(final Profile profile, Uri
