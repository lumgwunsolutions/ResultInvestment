...
import group.lsg.resultinvestmentapp.Class.LogUtil;
import group.lsg.resultinvestmentapp.Class.ValidationUtil;
...
public abstract class PickImageActivity extends BaseActivity {
    ...
    private static final String SAVED_STATE_IMAGE_URI =
            "RegistrationActivity.SAVED_STATE_IMAGE_URI";
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(SAVED_STATE_IMAGE_URI)) {
                imageUri =
                        savedInstanceState.getParcelable(SAVED_STATE_IMAGE_URI);
    ...
    protected void loadImageToImageView() {
        ...
        Glide.with(this)
                ...
                .listener(new RequestListener<Uri, GlideDrawable>() {
                    ...
                    @Override
                    public boolean onResourceReady(GlideDrawable resource, Uri model, Target<GlideDrawable> target, boolean
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE
            ...
            if (CropImage.isReadExternalStoragePermissionsRequired(this,
                    imageUri)) {
...
//                }
    ...
    protected void handleCropImageResult(int requestCode, int
    ...
    protected void startCropImageActivity() {
        ...
        CropImage.activity(imageUri)
                ...
                .setMinCropResultSize(Constants.Profile.MIN_AVATAR_SIZE,
                        Constants.Profile.MIN_AVATAR_SIZE)
                .setRequestedSize(Constants.Profile.MAX_AVATAR_SIZE,
                        Constants.Profile.MAX_AVATAR_SIZE)
                .start(this);
    }
}
